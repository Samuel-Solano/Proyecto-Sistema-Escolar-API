...
# Define aquí quién puede conectarse.
# IMPORTANTE: Cambia 'https://tu-proyecto.vercel.app' por la URL real de tu Vercel.
CORS_ALLOWED_ORIGINS = [
    'http://localhost:4200',
    "https://proyecto-sistema-escolar-webapp.vercel.app",
    "https://proyecto-sistema-escolar-webapp-dg7u9s5le.vercel.app",
]
