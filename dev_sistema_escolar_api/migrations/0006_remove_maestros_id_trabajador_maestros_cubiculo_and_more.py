# Generated by Django 5.0.2 on 2025-10-17 05:29
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dev_sistema_escolar_api', '0005_maestros'),
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[('Desarrollo Web', 'Desarrollo Web'), ('Programación', 'Programación'), ('Bases de datos', 'Bases de datos'), ('Redes', 'Redes'), ('Matemáticas', 'Matemáticas')], max_length=255, null=True),
        ),
        migrations.AlterField(
            model_name='maestros',
            name='materias_json',
